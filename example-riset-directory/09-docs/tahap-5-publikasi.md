...
- **Metodologi**: Spesifikasi data (140 vs 10k), rumus AHP-TOPSIS, rumusan Spearman & Kendall Tau, dan alur perulangan penyuntikan deviasi pada skrip CLI.
- **Hasil**: Narasi tabel *Baseline*, grafik penurunan $\rho$ seiring perbesaran $\Delta W$, serta fenomena eksponensial *runtime* matriks 10k.
